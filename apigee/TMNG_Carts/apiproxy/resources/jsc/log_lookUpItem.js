...
rootElement.timeTaken = context.getVariable("apigee.metrics.policy.cf_cortexTargetCalloutLookupItemForSKU.timeTaken");
...
context.setVariable("lookUpItemServiceCallout", JSON.stringify(rootElement));
