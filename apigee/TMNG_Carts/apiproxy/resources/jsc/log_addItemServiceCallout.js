...
rootElement.timeTaken = context.getVariable("apigee.metrics.policy.cf_cortexTargetCalloutAddItem.timeTaken");
...
context.setVariable("addItemServiceCallout", JSON.stringify(rootElement));
