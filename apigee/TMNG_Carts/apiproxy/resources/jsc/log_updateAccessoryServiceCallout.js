...
var request = {};
var response = {};
var statusCode= context.getVariable("ep.response.status.code");
...
if(logType=="DEBUG"){
	response.content = context.getVariable("ep.response.content");
}

rootElement.timeStamp=getFormattedDate();
rootElement.timeTaken = context.getVariable("apigee.metrics.policy.updateAccessory_CalloutAddAccessory.timeTaken");
...
context.setVariable("updateAccessoryServiceCallout", JSON.stringify(rootElement));
