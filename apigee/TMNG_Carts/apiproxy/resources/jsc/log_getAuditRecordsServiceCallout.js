...
rootElement.timeTaken = context.getVariable("apigee.metrics.policy.log_getAuditRecordsServiceCallout.timeTaken");
...
context.setVariable("getAuditRecordsServiceCallout", JSON.stringify(rootElement));
