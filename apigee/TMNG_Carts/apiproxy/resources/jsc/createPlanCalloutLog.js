...
rootElement.timeTaken = context.getVariable("apigee.metrics.policy.cf_cortexTargetCallout.timeTaken");
...
context.setVariable("createPlanCallLog", JSON.stringify(rootElement));
