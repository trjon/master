...
var request = {};
var response = {};
var statusCode= context.getVariable("ep.noneCreditResponse.status.code");
...
if(logType=="DEBUG"){
response.content = context.getVariable("ep.noneCreditResponse.content");
}

rootElement.timeStamp=getFormattedDate();
rootElement.timeTaken = context.getVariable("apigee.metrics.policy.getCartPricePreview_cartPriceForNoneCredit.timeTaken");
...
context.setVariable("noneCreditCallLog", JSON.stringify(rootElement));
