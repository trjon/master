...
rootElement.timeTaken = context.getVariable("apigee.metrics.policy.addAccessory_CalloutAddAccessory.timeTaken");
...
context.setVariable("addAccessoryServiceCallout", JSON.stringify(rootElement));
