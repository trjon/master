...
rootElement.timeTaken = context.getVariable("apigee.metrics.policy.cf_cortexTargetCalloutWithZoom.timeTaken");
rootElement.url=context.getVariable("servicecallout.requesturi");
rootElement.verb = context.getVariable("ep.request.verb");
rootElement.request = request;
rootElement.response=response;

context.setVariable("defaultCartCallLog", JSON.stringify(rootElement));
