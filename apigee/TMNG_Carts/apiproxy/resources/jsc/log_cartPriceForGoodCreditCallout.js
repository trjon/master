...
var request = {};
var response = {};
var statusCode= context.getVariable("ep.goodCreditResponse.status.code");
...
if(logType=="DEBUG"){
response.content = context.getVariable("ep.goodCreditResponse.content");
}
...
context.setVariable("goodCreditCallLog", JSON.stringify(rootElement));
