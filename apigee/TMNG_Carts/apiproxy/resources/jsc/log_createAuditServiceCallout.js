...
rootElement.timeTaken = context.getVariable("apigee.metrics.policy.createAudit_serviceCallout.timeTaken");
...
context.setVariable("createAuditServiceCallout", JSON.stringify(rootElement));
